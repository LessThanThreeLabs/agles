...
exports.create = (configurationParams, stores, modelRpcConnection) ->
	...
	createAccountHandler = CreateAccountHandler.create configurationParams, stores.createAccountStore, modelRpcConnection, accountInformationValidator
	loginHandler = LoginHandler.create configurationParams, modelRpcConnection
