...
describe 'Koality filters', () ->
	...
	describe 'ansiparse filter', () ->
		...
		it 'should escape spaces', () ->
			expect(ansiparse 'this is  A   test').toBe '<span class="ansi"><span class="foregroundDefault backgroundDefault">this&nbsp;is&nbsp;&nbsp;A&nbsp;&nbsp;&nbsp;test</span></span>'

		it 'should handle changing columns', () ->
			expect(ansiparse 'one\x1b[5Gtwo').toBe '<span class="ansi"><span class="foregroundDefault backgroundDefault">one&nbsp;&nbsp;two</span></span>'
		...
		it 'should handle colors, bold, and clearing', () ->
			expect(ansiparse '\x1b[33;45;1mbright yellow on magenta, \x1b[0mdefault').toBe '<span class="ansi"><span class="foregroundYellow backgroundMagenta bright">bright&nbsp;yellow&nbsp;on&nbsp;magenta,&nbsp;</span>' +
		...
		it 'should handle carriage returns', () ->
			expect(ansiparse '123456789\r9876').toBe '<span class="ansi"><span class="foregroundDefault backgroundDefault">987656789</span></span>'

		it 'should escape dangerous characters', () ->
			expect(ansiparse '&<>"\'/').toBe '<span class="ansi"><span class="foregroundDefault backgroundDefault">&amp;&lt;&gt;&quot;&#39;&#x2F;</span></span>'
