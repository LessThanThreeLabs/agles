...
class VerificationRequestHandler(QueueListener):
	...
	def handle_message(self, body, message):
		...
		with ModelServer.rpc_connect("builds", "update") as builds_update_rpc:
			with ModelServer.rpc_connect("build_outputs", "update") as build_outputs_update_rpc:
				console_appender = self._make_console_appender(build_outputs_update_rpc, build_id)
				verify_callback = self.make_verify_callback(build_id, builds_update_rpc, build_outputs_update_rpc, message)
	...
	def make_verify_callback(self, build_id, builds_update_rpc, build_outputs_update_rpc, message):
