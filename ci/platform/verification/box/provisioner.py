...
class Provisioner(object):
	...
	def provision(self, config_path):
	...
	def handle_config(self, config):
		...
		setup_steps = setup_steps + self.parse_setup(config)
	...
	def parse_scripts(self, script_config):
		script_steps = []
		for script_info in script_config:
			script_steps.append(ScriptParser().parse_script(script_info))
		return script_steps

	def parse_databases(self, database_config):
		database_steps = []
